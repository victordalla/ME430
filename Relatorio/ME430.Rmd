...
A principal ferramenta usada foi a linguagem de programação R. Nela, foram utilizados os pacotes: *readr* para leitura de dados; *dplyr*, *magrittr* e *tidyr* para manipulaão de dados, *fastkendall* **PARA O QUE???**, *psych* **PARA O QUE???**. Os códigos produzidos estão disponíveis em https://github.com/victordalla/ME430.
